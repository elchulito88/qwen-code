...
const SETTINGS_SCHEMA = {
  ...
  providers: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Configuration for local model providers (Ollama, LM Studio, HuggingFace).',
    showInDialog: false,
    properties: {
      preferred: {
        type: 'string',
        ...
        description: 'Preferred provider: auto, ollama, lmstudio, huggingface, cloud',
        showInDialog: true,
      },
      ollama: {
        type: 'object',
        ...
        requiresRestart: true,
        default: {},
        description: 'Ollama provider settings.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
          ...
          endpoint: {
            ...
            category: 'Model',
            requiresRestart: true,
            default: 'http://localhost:11434' as string,
          ...
          defaultModel: {
            ...
            category: 'Model',
            requiresRestart: true,
            default: 'qwen2.5-coder:7b' as string,
      ...
      lmstudio: {
        ...
        requiresRestart: true,
        default: {},
        description: 'LM Studio provider settings.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            ...
            requiresRestart: true,
            default: true,
            description: 'Enable LM Studio provider',
            showInDialog: true,
          },
          endpoint: {
            type: 'string',
            ...
            category: 'Model',
            requiresRestart: true,
            default: 'http://127.0.0.1:1234' as string,
            description: 'LM Studio API endpoint',
            showInDialog: true,
          },
          defaultModel: {
            type: 'string',
            label: 'Default LM Studio Model',
            category: 'Model',
            requiresRestart: true,
            default: 'qwen3-coder-30b' as string,
            description: 'Default model to use with LM Studio',
            showInDialog: true,
          },
          contextWindow: {
            type: 'number',
            ...
            requiresRestart: true,
            default: 262144,
            description: 'Context window size for LM Studio models',
            showInDialog: true,
          },
        },
      },
      huggingface: {
        type: 'object',
        label: 'HuggingFace Configuration',
        category: 'Model',
        requiresRestart: true,
        default: {},
        description: 'HuggingFace provider settings.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            label: 'Enable HuggingFace',
            category: 'Model',
            requiresRestart: true,
            default: true,
            description: 'Enable HuggingFace provider',
            showInDialog: true,
          },
          defaultModel: {
            type: 'string',
            label: 'Default HuggingFace Model',
            category: 'Model',
            requiresRestart: true,
            default: 'Qwen/Qwen2.5-Coder-7B-Instruct' as string,
            description: 'Default model to use with HuggingFace',
            showInDialog: true,
          },
          apiKey: {
            type: 'string',
            ...
            requiresRestart: true,
            default: undefined as string | undefined,
            description: 'HuggingFace API key for inference',
            showInDialog: false,
          },
        },
      },
      cloud: {
        ...
        properties: {
          enabled: {
            ...
            requiresRestart: true,
            default: true,
            description: 'Enable cloud provider (requires explicit user consent)',
            showInDialog: true,
          },
        },
      },
  ...
  customizations: {
    ...
    requiresRestart: false,
    default: {},
    description: 'Track custom modifications to this fork.',
    showInDialog: false,
    properties: {
      version: {
        type: 'string',
        label: 'Customization Version',
        category: 'Advanced',
        requiresRestart: false,
        default: '1.0.0' as string,
        description: 'Version of custom modifications',
        showInDialog: false,
      },
      lastUpstreamSync: {
        type: 'string',
        label: 'Last Upstream Sync',
        category: 'Advanced',
        requiresRestart: false,
        default: undefined as string | undefined,
        description: 'Timestamp of last sync with upstream',
        showInDialog: false,
      },
    },
  },
